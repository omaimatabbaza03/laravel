...
<body>
    ...
    <section class="home-section">
        <div class="allp">
            <nav>
                <h1>modifier Hotels</h1>
            </nav>
            <center>
                <div class="container">
                    <form method="post"  
                    action="{{route('hotel.update',$hotels->idHotel)}}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="inputs">
                                ...
                                <td>
                                    <input type="number" name="idHotel" value="{{$hotels->idHotel}}">
                                </td>
                                <td>
                                    <label>Nom Hotel</label>
                                </td>
                                <td>
                                    <input type="text" name="nom" value="{{$hotels->nom}}" />
                                </td>
                            </tr>
                           <tr>
                                <td>
                                    <label>Number etoile</label>
                                </td>
                                    <td>
                                    <input type="text" name="nbetoils" value="{{$hotels->nbetoils}}">
                                    </td>
                                <td>
                                    <label>ville</label>
                                </td>
                                <td>
                                    <input type="text" name="ville" value="{{$hotels->ville}}" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <td> <input type="text" name="pays"  value="{{$hotels->pays}}"/>
                                </td>
                            </tr>
                            ...
                            <!-- ___________________________________________________________ -->
                                ...
                                <button type="submit" name="enr">Modifier</button>
                            </td>
                            </tr>
                            </table>
                        </div>
